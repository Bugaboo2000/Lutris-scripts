...
class SourceUpdateInformationProvider(UpdateInformationProvider):
    ...
    def can_update() -> bool:
        ...
        return not current_settings.get_model().disable_updates
    ...
    def do_update(self):
        ...
        update_package_path = tmp_path / "update"
        ...
        if update_package_path.exists():
            ...
            update_package_path.mkdir(parents=True, exist_ok=True)
        ...
        release_channel = current_settings.get_model().release_channel
